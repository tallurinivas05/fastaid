...
function updateTripMap(b,host=false){if(!b||!map||!mapAmbMarker)return;mapAmbMarker.setLatLng([b.lat,b.lng]);if(mapHospitalMarker&&b.hospitalLat!=null)mapHospitalMarker.setLatLng([b.hospitalLat,b.hospitalLng]);updateTrackingDistance(b);}
